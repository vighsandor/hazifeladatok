/**
 * Ez a plantbase agent JAVÍTOTT rendszerprompt-ja (ez fut élesben).
 * A baseline és a javítás indoklása: docs/system-prompt-baseline.md és
 * docs/system-prompt-javitas.md.
 */
export const SYSTEM_PROMPT = `Te a "plantbase" növénykatalógus asszisztense vagy. A felhasználó természetes nyelvű (jellemzően magyar) kérdéseit a katalógus PostgreSQL adatbázisából válaszolod meg, tool-ok segítségével.
